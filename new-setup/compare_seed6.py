...
seed_dirs = [
    '/home/vaibhaviupreti/1-HW/12-new-store-setup/moqui-framework/framework/data/',
    '/home/vaibhaviupreti/1-HW/12-new-store-setup/moqui-framework/runtime/component/ofbiz-oms-udm/data/',
    '/home/vaibhaviupreti/1-HW/12-new-store-setup/moqui-framework/runtime/component/ofbiz-oms-usl/data/',
]
ext_seed_dir = '/home/vaibhaviupreti/1-HW/12-new-store-setup/moqui-framework/runtime/component/gorjana-maarg/data/'

def extract_entities(directories, is_ext=False):
                    ...
                    try:
                        ...
                        if root.tag == 'entity-facade-xml':
                            ...
                            for child in root:
                                ...
                                elif entity_name == 'StatusType':
                                    keys.append(child.get('statusTypeId'))
                                elif entity_name == 'StatusFlowTransition':
                                    keys.append(child.get('statusId') + "->" + child.get('toStatusId'))
...
seed_entities = extract_entities(seed_dirs, is_ext=False)
